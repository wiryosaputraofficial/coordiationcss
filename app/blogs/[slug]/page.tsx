...
export default async function BlogArticlePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <main className="blog-article-page" id="top">
    ...
    <header className="site-header blogs-header"><Link className="brand" href="/" aria-label="Coordiation home"><img src="/coordiation-logo.png" alt="" /><span>Coordiation</span><span className="brand-product">Journal</span></Link><nav aria-label="Article navigation"><Link href="/blogs">Blogs</Link><Link href="/cookbook">Cookbook</Link><Link href="/components">Components</Link><Link href="/themes">Themes</Link><Link href="/docs">Docs</Link></nav><MobileNav /><Link className="header-cta co-inline-flex co-items-center" href="/blogs">Journal index <SolarIcon name="arrow-right" size={15} /></Link></header>
    <article>
