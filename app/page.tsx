...
const integrations = [
  ...
  { name: "Themes", label: "5 complete applications", description: "Original, responsive portfolios, journals, dashboards, creative studios, and industrial sites with live previews, owned source, Coordiation components, install endpoints, and section-level AI contracts.", href: "/themes", code: "@coordiation/themes" },
];
