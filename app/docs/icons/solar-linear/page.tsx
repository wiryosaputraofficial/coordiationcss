...
export default function SolarLinearIconsPage() {
  return <article className="docs-article vite-guide">
    ...
    <div className="family-support"><span>Need the complete visual catalog?</span><Link prefetch={false} href="/icons">Browse all 2,165 icons →</Link></div>
...
.navigation {
  ...
  "import": "@coordiation/icons/linear/home"
    ...
    <div className="docs-next split"><Link prefetch={false} href="/icons"><span>Interactive catalog</span><b>← Browse all icons</b></Link><Link prefetch={false} href="/docs/icons/iconsax-line-oval"><span>Next collection</span><b>Iconsax Line Oval →</b></Link></div>
  </article>;
}
