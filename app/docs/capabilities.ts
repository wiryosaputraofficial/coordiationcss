...
export const capabilities: Capability[] = [
  ...
  { id: "theme-variables", area: "CSS-first theme variables", status: "complete", target: "0.1", examples: ["--co-color-brand-500", "--co-background-image-hero", "--co-blur-glass"], note: "Colors, background images, spacing, fonts, radii, box/inset/text shadows, blur, drop-shadow, and breakpoints are tokenized." },
