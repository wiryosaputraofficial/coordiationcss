...
export const capabilities: Capability[] = [
  ...
  { id: "layout", area: "Layout and positioning", status: "complete", target: "0.2", examples: ["co-aspect-3/2", "co-sticky", "-co-inset-x-4", "co-break-inside-avoid", "-co-z-10", "co-object-[25%_75%]"], note: "Display, box model, aspect ratio, page/column breaks, position and logical inset, float/clear, isolation, overflow/overscroll, object fit/position, visibility, and z-index are registry-backed, documented, and tested." },
