...
export const capabilities: Capability[] = [
  ...
  { id: "arbitrary", area: "Arbitrary properties and values", status: "partial", target: "0.2", examples: ["co-w-[42rem]", "co-[mask-type:luminance]"], note: "Core arbitrary syntax ships; type hints and ambiguity handling remain." },
  ...
  { id: "state-variants", area: "State and structural variants", status: "partial", target: "0.2", examples: ["hover:co-bg-black", "first:co-mt-0"], note: "Common state, form, structural, and pseudo-element variants ship." },
  { id: "context-variants", area: "Dark, RTL, group, and peer", status: "partial", target: "0.2", examples: ["dark:co-text-white", "group-hover:co-block"], note: "Core context variants ship; named and nested groups remain." },
  { id: "attribute-variants", area: "ARIA, data, has, and not", status: "partial", target: "0.2", examples: ["aria-expanded:co-block", "has-[img]:co-p-0"], note: "Boolean and arbitrary attribute selectors compile." },
  { id: "conditional-variants", area: "Media, supports, and container variants", status: "partial", target: "0.2", examples: ["print:co-hidden", "supports-[display:grid]:co-grid"], note: "Core conditional at-rules compile; named containers remain." },
  ...
  { id: "svg", area: "SVG fill and stroke", status: "partial", target: "0.2", examples: ["co-fill-current", "co-stroke-black"], note: "Theme and arbitrary colors ship; stroke width remains." },
  { id: "accessibility", area: "Accessibility and forced colors", status: "partial", target: "0.2", examples: ["co-sr-only", "forced-colors:co-outline-solid"], note: "Screen-reader and forced-color variants ship; broader adjustments remain." },
