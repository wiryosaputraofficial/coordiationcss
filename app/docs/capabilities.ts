...
export const capabilities: Capability[] = [
  ...
  { id: "theme-variables", area: "CSS-first theme variables", status: "complete", target: "0.1", examples: ["--co-color-brand-500", "--co-background-image-hero"], note: "Colors, background images, spacing, fonts, radii, shadows, and breakpoints are tokenized." },
