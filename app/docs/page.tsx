...
export default function DocsOverview() {
  return (
    <article className="docs-article">
      ...
      <div className="docs-callout"><strong>Feature implementation complete</strong><p>All 45 tracked capability areas are implemented and documented. The project remains prerelease until the stable release process, signed native artifacts, and supported-platform checks pass.</p><Link href="/release-check">Open Release Check →</Link></div>
