...
Coordiation CSS: watch stopped.`} /></div></section>
      ...
      <section className="family-concepts" id="configuration">
        ...
        <ol><li><span>01</span><p><strong>-i / --input:</strong> CSS entry containing <code>@coordiation</code>.</p></li><li><span>02</span><p><strong>-o / --output:</strong> generated static stylesheet path.</p></li><li><span>03</span><p><strong>-c / --content:</strong> repeatable or comma-separated files and directories.</p></li><li><span>04</span><p><strong>--include / --exclude / --safelist:</strong> literal scanner controls.</p></li><li><span>05</span><p><strong>--cache-dir / --no-cache:</strong> relocate persistent state or run deliberately cold.</p></li><li><span>06</span><p><strong>--no-imports / --no-nesting / --no-prefixing:</strong> preserve a stage for another build tool.</p></li><li><span>07</span><p><strong>--minify / --target:</strong> optimize output and declare repeatable browser targets.</p></li><li><span>08</span><p><strong>--prefix / --no-diagnostics / --no-preflight:</strong> compiler syntax and diagnostics controls.</p></li><li><span>09</span><p><strong>-w / --watch and --poll:</strong> enable durable watching and optionally tune its interval.</p></li></ol>
      </section>
