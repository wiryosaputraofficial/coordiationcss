...
coordiation-css: Unsupported candidate: co-does-not-exist`} /></div></section>
      ...
      <section className="family-concepts" id="configuration">
        ...
        <ol><li><span>01</span><p><strong>content:</strong> source files or directories; defaults to <code>[&quot;src&quot;]</code>.</p></li><li><span>02</span><p><strong>cwd:</strong> explicit project root for resolving content paths.</p></li><li><span>03</span><p><strong>cache:</strong> process-local source and compilation reuse; defaults to <code>true</code>.</p></li><li><span>04</span><p><strong>toolchain:</strong> controls imports, nesting, prefixing, minification, and browser targets.</p></li><li><span>05</span><p><strong>include / exclude / safelist:</strong> literal scan-boundary controls.</p></li><li><span>06</span><p><strong>extractors:</strong> extension-specific or global extraction hooks.</p></li><li><span>07</span><p><strong>preflight:</strong> set to <code>false</code> only when another reset owns base styles.</p></li></ol>
      </section>
