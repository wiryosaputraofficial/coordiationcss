...
const navigation = [
  ...
  { title: "Framework guides", items: [["Next.js", "/docs/installation/using-nextjs"], ["Astro", "/docs/installation/using-astro"], ["Laravel", "/docs/installation/using-laravel"], ["SvelteKit", "/docs/installation/using-svelte"], ["HTML + CSS", "/docs/installation/using-html-css"], ["PHP", "/docs/installation/using-php"], ["WordPress", "/docs/installation/using-wordpress"]] },
