...
const navigation = [
  { title: "Getting started", items: [["Installation", "/docs"], ["Using Vite", "/docs/installation/using-vite"], ["Icon library", "/docs/icons/solar-linear"], ["Editor setup", "/docs/tooling/language-server"], ["Compatibility", "/docs/core/compatibility"]] },
  ...
  { title: "Icons", items: [["Browse all icons", "/icons"], ["Solar Linear guide", "/docs/icons/solar-linear"], ["Icon registry", "/icon-registry.json"]] },
  ...
  return (
    <div className="reference-page">
      <header className="reference-header">
        ...
        <nav aria-label="Documentation links"><Link prefetch={false} href="/icons">Icons</Link><Link prefetch={false} href="/release-check">Release Check</Link><a href="/api/capabilities">API</a><Link prefetch={false} className="docs-home-link" href="/">Home ↗</Link></nav>
      </header>
