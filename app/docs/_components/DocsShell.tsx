  ...
  return (
    <div className="reference-page">
      <header className="reference-header">
        ...
        <nav aria-label="Documentation links"><Link prefetch={false} href="/cookbook">Cookbook</Link><Link prefetch={false} href="/blogs">Journal</Link><Link prefetch={false} href="/themes">Themes</Link><Link prefetch={false} href="/components">Components</Link><Link prefetch={false} href="/icons">Icons</Link><Link prefetch={false} href="/release-check">Release Check</Link><a href="/api/capabilities">API</a><Link prefetch={false} className="docs-home-link" href="/">Home <SolarIcon name="arrow-to-top-right" size={14} /></Link></nav>
        <MobileNav />
      </header>
