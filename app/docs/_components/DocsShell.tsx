...
const navigation = [
  ...
  { title: "Core concepts", items: [["Utility classes", "#utility-classes"], ["Responsive design", "#responsive-design"], ["Attribute selectors", "/docs/variants/attribute-selectors"], ["Conditional variants", "/docs/variants/conditional-rules"], ["Theme variables", "#theme-variables"]] },
