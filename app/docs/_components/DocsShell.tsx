...
const navigation = [
  ...
  { title: "Core concepts", items: [["Utility classes", "#utility-classes"], ["Preflight", "/docs/core/preflight"], ["Responsive design", "#responsive-design"], ["Attribute selectors", "/docs/variants/attribute-selectors"], ["Conditional variants", "/docs/variants/conditional-rules"], ["Theme variables", "#theme-variables"]] },
  { title: "Core utilities", items: [["Utility registry", "/docs/utilities"], ["Layout", "/docs/utilities/layout"], ["Flexbox & Grid", "/docs/utilities/flex-grid"], ["Spacing", "/docs/utilities/spacing"], ["Sizing", "/docs/utilities/sizing"], ["Typography", "/docs/utilities/typography"], ["Backgrounds", "/docs/utilities/backgrounds"], ["Borders & Rings", "/docs/utilities/borders-rings"], ["Effects", "/docs/utilities/effects"], ["Tables & Columns", "/docs/utilities/tables-columns"], ["Transforms & 3D", "/docs/utilities/transforms"], ["Transitions", "/docs/utilities/transitions"], ["SVG", "/docs/utilities/svg"], ["Accessibility", "/docs/utilities/accessibility"], ["Interactivity", "/docs/utilities/interaction"], ["Arbitrary properties", "/docs/utilities/arbitrary-properties"]] },
