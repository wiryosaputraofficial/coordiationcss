...
const navigation = [
  ...
  { title: "Core concepts", items: [["Utility classes", "#utility-classes"], ["Custom utilities", "/docs/core/custom-utilities"], ["Custom variants", "/docs/core/custom-variants"], ["Plugin API", "/docs/core/plugin-api"], ["Preflight", "/docs/core/preflight"], ["Logical properties", "/docs/core/logical-properties"], ["Modern color", "/docs/core/modern-color"], ["Responsive design", "/docs/core/responsive-design"], ["Attribute selectors", "/docs/variants/attribute-selectors"], ["Conditional variants", "/docs/variants/conditional-rules"], ["Theme variables", "/docs/core/theme-variables"]] },
  ...
  { title: "Tooling", items: [["CSS toolchain", "/docs/tooling/css-toolchain"], ["Incremental cache", "/docs/tooling/incremental-cache"], ["Source maps", "/docs/tooling/source-maps"], ["Vite", "/docs/installation/using-vite"], ["PostCSS", "/docs/installation/using-postcss"], ["CLI", "/docs/installation/using-cli"], ["AI integration", "#ai-integration"]] },
] as const;
