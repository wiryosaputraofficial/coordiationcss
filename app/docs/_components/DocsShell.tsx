...
const navigation = [
  ...
  { title: "Tooling", items: [["CSS toolchain", "/docs/tooling/css-toolchain"], ["Incremental cache", "/docs/tooling/incremental-cache"], ["Vite", "/docs/installation/using-vite"], ["PostCSS", "/docs/installation/using-postcss"], ["CLI", "/docs/installation/using-cli"], ["AI integration", "#ai-integration"]] },
] as const;
