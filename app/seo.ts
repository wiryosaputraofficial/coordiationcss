...
export const STATIC_INDEXABLE_ROUTES = [
  ...
  "/components",
  "/discussions",
  "/discussions/responsive-variants-from-component-props",
  "/discussions/dialog-focus-restoration-inside-sheet",
  "/discussions/share-your-first-coordination-theme",
  "/discussions/vite-monorepo-content-roots",
  "/discussions/agent-context-for-existing-product",
  "/discussions/theme-installer-preserve-existing-files",
  "/docs",
  "/docs/components",
