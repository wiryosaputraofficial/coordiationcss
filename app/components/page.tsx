  ...
  return (
    <main className="components-page">
      <header className="site-header">
        ...
        <nav aria-label="Main navigation"><Link href="/">Home</Link><Link href="/blogs">Blogs</Link><Link href="/themes">Themes</Link><Link href="/icons">Icons</Link><Link href="/docs/components">Component guide</Link><Link href="/release-check">Release Check</Link></nav>
        <MobileNav />
      ...
      <section className="components-hero">
        ...
        <div className="components-hero-demo" aria-label="Component installation example"><div className="component-terminal-top"><span>coordiation install</span><i>ready</i></div><pre><code><span>$</span> npx @coordiation/cli@next add{`\n`}  component button</code></pre><div className="component-terminal-result"><b><SolarIcon name="check-circle" size={17} /></b><span>components/ui/button.tsx</span><em>owned source</em></div></div>
      </section>
